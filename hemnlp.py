...
# train_data_path = '/content/drive/My Drive/Machine Learning/Hem/train_hem'
# test_data_path = '/content/drive/My Drive/Machine Learning/Hem/test_hem'
...
# model.save_model('/content/drive/My Drive/Machine Learning/Hem/super_best_model_200_percent_accuracy_0_loss.txt')
